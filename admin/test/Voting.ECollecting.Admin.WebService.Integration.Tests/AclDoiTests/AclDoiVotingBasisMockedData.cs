...
public static class AclDoiVotingBasisMockedData
{
    ...
    public static PoliticalDomainOfInfluence SG_StGallen_L5_MU
        => new()
        {
            ...
            ECollectingReferendumMinSignatureCount = 10_000,
            ECollectingReferendumMaxElectronicSignaturePercent = 20,
            ECollectingEmail = "st.gallen+staatskanzlei@abraxas.ch",
            SortNumber = 1,
