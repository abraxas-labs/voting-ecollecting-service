...
public class ListInitiativesRequestTest : ProtoValidatorBaseTest<ListInitiativesRequest>
{
    protected override IEnumerable<ListInitiativesRequest> OkMessages()
    {
    ...
    protected override IEnumerable<ListInitiativesRequest> NotOkMessages()
    {
    ...
    private ListInitiativesRequest NewValidRequest(Action<ListInitiativesRequest>? customizer = null)
    {
        var request = new ListInitiativesRequest
        {
