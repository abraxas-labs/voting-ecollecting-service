...
public static partial class TemplateBagMapper
{
    ...
    [MapProperty([nameof(SignatureSheetAttestationTemplateData.DomainOfInfluence), nameof(SignatureSheetAttestationTemplateData.DomainOfInfluence.Name)], nameof(SignatureSheetAttestationTemplateBag.MunicipalityName))]
    [MapProperty([nameof(SignatureSheetAttestationTemplateData.DomainOfInfluence), nameof(SignatureSheetAttestationTemplateData.DomainOfInfluence.NameForProtocol)], nameof(SignatureSheetAttestationTemplateBag.MunicipalityNameIncludingType))]
    ...
    [MapProperty([nameof(SignatureSheetAttestationTemplateData.DomainOfInfluence), nameof(SignatureSheetAttestationTemplateData.DomainOfInfluence.AddressName)], nameof(SignatureSheetAttestationTemplateBag.MunicipalityAddressName))]
