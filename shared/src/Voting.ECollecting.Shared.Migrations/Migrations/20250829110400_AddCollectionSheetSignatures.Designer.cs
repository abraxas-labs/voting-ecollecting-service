...
namespace Voting.ECollecting.Admin.Adapter.Data.Migrations
{
    ...
    [Migration("20250829110400_AddCollectionSheetSignatures")]
    partial class AddCollectionSheetSignatures
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Voting.ECollecting.Shared.Domain.Entities.CollectionCitizenEntity", b =>
                {
                    ...
                    b.Property<string>("MunicipalityBfs")
                        .IsRequired()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Voting.ECollecting.Shared.Domain.Entities.CollectionSignatureSheetEntity", b =>
                {
                    ...
                    b.HasIndex("CollectionId", "Bfs", "Number")
                        .IsUnique();

                    b.ToTable("CollectionSignatureSheets");
                });

            modelBuilder.Entity("Voting.ECollecting.Shared.Domain.Entities.CollectionSignatureSheetNumberCounterEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("Bfs", "CollectionId")
                        .IsUnique();

                    b.ToTable("CollectionSignatureSheetNumberCounters");
                });
